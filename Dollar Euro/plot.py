...
pruned=pd.read_csv("pruned_expfinal.csv",index_col=None).drop("Unnamed: 0",axis=1)

traditional=pd.read_csv("traditional_expfinal.csv", index_col=None).drop("Unnamed: 0",axis=1)
